...
export default function Home() {
  ...
  const healthBg = healthScore >= 75 ? 'from-green-900/30 to-gray-900' : healthScore >= 50 ? 'from-yellow-900/30 to-gray-900' : 'from-red-900/30 to-gray-900'
  ...
  return (
    <main className="min-h-screen bg-gray-950 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Health Score */}
        <div className={`bg-gradient-to-r ${healthBg} rounded-2xl p-6 border border-gray-800 mb-6`}>
